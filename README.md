...
## Swift version
The latest version of Kitura works with the DEVELOPMENT-SNAPSHOT-2016-06-06-a version of the Swift binaries. You can download this version of the Swift binaries by following this [link](https://swift.org/download/). Compatibility with other Swift versions is not guaranteed.
...
8. Optionally add logging
   ...
   *IMPORTANT:* You need to add HeliumLogger to your `Package.swift` file. It should look like this:
   ```Swift
   import PackageDescription
   let package = Package(
    name: "myFirstProject",
    dependencies: [
        .Package(url: "https://github.com/IBM-Swift/Kitura.git", majorVersion: 0, minor: 19),
        .Package(url: "https://github.com/IBM-Swift/HeliumLogger", majorVersion: 0, minor: 8),
    ])
   ```
