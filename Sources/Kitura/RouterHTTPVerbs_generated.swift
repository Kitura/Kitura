...
extension Router {
    ...
    public func error(_ path: String?=nil, handler: RouterHandler...) -> Router {
	return routingHelper(.error, pattern: path, handler: handler)
    }
    ...
    public func error(_ path: String?=nil, middleware: RouterMiddleware...) -> Router {
	return routingHelper(.error, pattern: path, middleware: middleware)
    }
