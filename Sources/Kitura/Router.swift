...
public class Router {
    ...
    public init(mergeParameters: Bool = false, enableWelcomePage: Bool = true, apiDocument: SwaggerDocument = SwaggerDocument()) {
        ...
        self.openapi = OpenAPI.Document(info: OpenAPI.Info(title: "Kitura Project", version: "1.0"))
        self.mergeParameters = mergeParameters
        self.fileResourceServer = enableWelcomePage ? FileResourceServer() : nil
        openAPIVersion = .swagger2_0
    ...
    ///                                "Welcome to Kitura" page and related
    ///                                assets.
    /// - Parameter apiDocument: Parameter that allows customization of the OpenAPI document 
    ///                          describing this Router using OpenAPI 3.0.
    public init(mergeParameters: Bool = false, enableWelcomePage: Bool = true, apiDocument: OpenAPI.Document) {
        self.swagger = SwaggerDocument(
            title: apiDocument.info.title,
            description: apiDocument.info.description ?? "Generated by Kitura",
            version: apiDocument.info.version)
        self.openapi = apiDocument
        self.mergeParameters = mergeParameters
        self.fileResourceServer = enableWelcomePage ? FileResourceServer() : nil
        openAPIVersion = .openapi3_0
    ...
    /// Contains the structures needed for OpenAPI 3.0+ document generation
    var openapi: OpenAPI.Document
    /// List of sub-routers added documents.
    var subRouters: [Router] = []

    public var openAPIVersion: OpenAPIVersion
    ...
    /// - Parameter tags: Specify the custom OpenAPI tags to use. If not set, it used the existing tags and add the route as a custom tag. 
