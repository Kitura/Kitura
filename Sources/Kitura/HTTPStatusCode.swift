...
/// Bridge [HTTPStatusCode](http://kitura.github.io/Kitura-net/Enums/HTTPStatusCode.html)
/// from [KituraNet](http://kitura.github.io/Kitura-net) so that you only need to import
/// `Kitura` to access it.
