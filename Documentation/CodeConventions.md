# The Kitura Swift Style Guide.

Based on [the Official raywenderlich.com Swift Style Guide](https://github.com/raywenderlich/swift-style-guide),
and [Swift API Design Guidelines](https://swift.org/documentation/api-design-guidelines/), with minor changes.
...
* Indent using 4 spaces rather than tabs to conserve space and help prevent line wrapping. Be sure to set this preference in Xcode and in the Project settings as shown below:
  ...
  ![Xcode indent settings](XcodeIndentation.png)

  ![Xcode Project settings](https://raw.githubusercontent.com/raywenderlich/swift-style-guide/master/screens/project_settings.png)
...
## Credits to [the Official raywenderlich.com Swift Style Guide](https://github.com/raywenderlich/swift-style-guide)
